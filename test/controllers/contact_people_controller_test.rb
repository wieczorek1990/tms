...
class ContactPeopleControllerTest < ActionController::TestCase
  ...
  test "should create contact_person" do
    assert_difference('ContactPerson.count') do
      post :create, contact_person: { email: @contact_person.email, first_name: @contact_person.first_name, last_name: @contact_person.last_name, phone: @contact_person.phone }
    end
  ...
  test "should update contact_person" do
    patch :update, id: @contact_person, contact_person: { email: @contact_person.email, first_name: @contact_person.first_name, last_name: @contact_person.last_name, phone: @contact_person.phone }
    assert_redirected_to contact_person_path(assigns(:contact_person))
  end
